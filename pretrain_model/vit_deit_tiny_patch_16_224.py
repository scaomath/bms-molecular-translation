...
PRETRAIN_CHECKPOINT = '../pretrain_model/deit_tiny_distilled_patch16_224-b40b3cf7.pth'
...
def make_vit_deit_tiny_distilled_patch16_224():
...
def run_check_pretrain_net():
    net = make_vit_deit_tiny_distilled_patch16_224()

    print(net)
    pretrain_state_dict = torch.load(PRETRAIN_CHECKPOINT, map_location=lambda storage, loc: storage)
    #state_dict = net.state_dict()

    s = net.load_state_dict(pretrain_state_dict['model'], strict=True)
    print(s)
