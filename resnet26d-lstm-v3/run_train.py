...
def run_train():
    fold = 3
    out_dir = \
        '/root/share1/kaggle/2021/bms-moleular-translation/result/try10/resnet26d-224-lstm-no-attention/fold%d' % fold
    initial_checkpoint = \
        None #out_dir + '/checkpoint/00038000_model.pth'#
    ...
    if initial_checkpoint is not None:
        ...
        encoder_.load_state_dict(state_dict, strict=False)  # True
