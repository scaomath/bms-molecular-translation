...
def cat_submit():
    ...
    for i in [3,2,1,0]:
        file=\
            '/root/share1/kaggle/2021/bms-moleular-translation/result/try10/tnt-s-224-fairseq/fold3/valid/remote-00266000_model-gpu%d/submit.csv'%i
        d = pd.read_csv(file)
        df.append(d)
    ...
    print(df)
    print(df.shape)
    df.to_csv('/root/share1/kaggle/2021/bms-moleular-translation/result/try10/tnt-s-224-fairseq/fold3/valid/submission-00266000_model.csv',index=False)
