...
def run_train():
    fold = 3
    out_dir = \
        '/root/share1/kaggle/2021/bms-moleular-translation/result/try10/resnet26d-224-lstm/fold%d' % fold
    initial_checkpoint = \
        out_dir + '/checkpoint/00204000_model.pth'#None #
        #'/root/share1/kaggle/2021/bms-moleular-translation/result/try02/resnet26d-224/fold3-1/checkpoint/00204000_model.pth'
    ...
    while iteration < num_iteration:
        ...
        for t, batch in enumerate(train_loader):
            ...
            def cross_entropy_loss(logit, truth):
            ...
            if is_mixed_precision:
                ...
                loss0 = cross_entropy_loss(logit, truth)
